...
BLOCK;
		...
		$bg_image_url = 'https://84em.com/wp-content/uploads/2025/10/84em-desktop-background-scaled.jpg';
...
<div class="wp-block-group alignfull has-contrast-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"style":{"background":{"backgroundImage":{"url":"{$bg_image_url}","id":12601,"source":"file","title":"84em-desktop-background"},"backgroundSize":"cover","backgroundPosition":"var(--hero-bg-position, 60% 45%)"},"dimensions":{"minHeight":"var(--hero-min-height, 250px)"},"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}},"layout":{"type":"constrained"}} -->
