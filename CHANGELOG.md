...
- **Testimonials Page Migration** - Replaced legacy synced pattern testimonials with Easy Testimonial Blocks plugin
  ...
  - Styling now handled entirely by Easy Testimonial Blocks plugin
...
### Removed
- **Testimonials CSS** - Deleted `assets/css/testimonials.css` and removed enqueue from `includes/enqueue.php`, styling now handled entirely by Easy Testimonial Blocks plugin
